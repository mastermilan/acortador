...
<div class="col-lg-12">
    ...
    <div class="w-100 d-flex justify-content-end">
        <b>Total de Urls</U>: <span id="total-item">-</span></b>
    </div>
    <div id="url-list">
        ...
        <div class="w-100 d-flex-responsive">
            <div class="w-20">
                ...
                <div class="d-flex justify-content-center">
                    <button class="btn btn-danger remove mr-2" type="button" title="Borrar dato"><span class="fa fa-trash"></span></button>
                    <button class="btn btn-default border copy_to_clip ml-2" type="button" title="Copiar URL Corta"><span class="fa fa-clone"></span></button>
                </div>
            </div>
            <div class="w-60 p-2">
                <p class="m-0"><span class="text-muted"><b>Redirecciona a: </b></span><span class="url-link"></span></p>
                <p class="m-0"><span class="text-muted"><b>URL Corta: </b></span><span class="url-short"></span></p>
                <p class="m-0"><span class="text-muted"><b>Creación: </b></span><span class="url-created"></span></p>
                <p class="m-0"><span class="text-muted"><b>Última visita: </b></span><span class="url-last"></span></p>
            </div>
            <div class='w-20 url-data' style="display:none">
                ...
                <hr>
                <p class="m-0 site-title truncate-2">Titulo</p>
            ...
            success:function(resp){
                if (typeof resp == "object" && Object.keys(resp).length > 0) {
                    ...
                    Object.keys(resp).map(function(k){
                        ...
                        //Area admin
                        card.find('.url-short').text("http://localhost/b?c="+resp[k].code)
            ...
            complete:function(){
                ...
                $('.copy_to_clip').click(function(e) {
                    ...
                    if (is_copied) {
                        ...
                        _msg.text("URL Copiada al Clipboard")
                ...
                $('.remove').click(function(){
                    ...
                    var conf = confirm("Seguro de remover "+code+" de forma permanente?")
                    if(conf == true)
                        delete_conf(code)
                    end_loader()
                })
